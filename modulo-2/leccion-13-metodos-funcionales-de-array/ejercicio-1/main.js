...
const marksDisplay = document.querySelector('.original-grades');
const newMarksDisplay = document.querySelector('.new-grades');

marksDisplay.innerHTML = marks;

const inflatedMarks = marks.map((mark) => mark + 1);
newMarksDisplay.innerHTML = inflatedMarks;
